...
function main() {
  ...
  partSys = new particleSystem(2, VSHADER_SOURCE, FSHADER_SOURCE);


  partSys.s0.setParticlePosition(0, [-1, 0, 1]);
  var vec = roundRand3D();
  partSys.s0.setParticleColor(0, [(vec[0]+1)*.5, (vec[1]+1)*.5, (vec[2]+1)*.5, 1]);
  partSys.s0.setParticleSize(0, 30);

  partSys.s0.setParticlePosition(1, [1, 0, 1]);
  var vec = roundRand3D();
  partSys.s0.setParticleColor(1, [(vec[0]+1)*.5, (vec[1]+1)*.5, (vec[2]+1)*.5, 1]);
  partSys.s0.setParticleSize(1, 30);


  var spring = new springForce(1.5, 20, [0, 1]);
