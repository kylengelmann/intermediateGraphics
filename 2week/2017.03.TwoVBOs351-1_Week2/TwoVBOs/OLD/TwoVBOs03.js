...
//==============================================================================
  ...
  var n = initVBO1();			// init the first returns # of vertices created
  if (n < 0) {
    console.log('Failed to create FIRST vertex buffer object in the GPU.');
    return;
  }
...
// Create a buffer object in the graphics hardware: save its ID# in global var: 
 ...
 // 			times and then discarded.
  ...
  return g_BufVerts1 + g_BufVerts2;
}
...
//==============================================================================
  ...
  // DRAW SECOND VBO:--------------------------- 	// spin in OPPOSITE direction:
