...
/* Demonstrate use of two separate VBOs with different contents & attributes. 
	...
	Clues:
		...
		=============================
		a)--EASY HACK WAY:  When we switch from rendering one VBO to another, use 
		...
		b)--BETTER, PROPER WAY:  If VBO1 and VBO2 hold different sets of vertices with different attributes that look different on-screen, then why are you trying to render them both with the same GLSL shader programs? Why are you using slow, awkward conditionals to select between tow different kinds of rendering?  Instead, write a separate GLSL shader program (vertex shader, fragment shader) for each VBO, and switch between those shader programs!  (See Book Chapter 10) This will eliminate the messy switching of attributes,too!		
*/
