...
/* Demonstrate use of two separate VBOs with different contents & attributes. 
	...
	09--BETTER, PROPER WAY:  
		...
		VBO2.  We willfollow "WebGL Programming Guide" textbook, Chap 10, pg. 386 
		example code: "ProgramObject.js".
		a)--Rename shaders (VSHADER_1SRC, FSHADER_1SRC) and test; 
		then make and test copies of them named (VSHADER_2SRC, FSHADER_2SRC).
		  --Modify 2nd shaders to look different; to blend colors w/ 50% purple.
		b)--In main(), replace the 'initShaders()' call with createProgram() calls (both found in textbook's 'cuon-utils.js' library); test both shaders again.
...
//==============================================================================
  ...
  if (!initShaders(gl, VSHADER_1SRC, FSHADER_1SRC)) {
