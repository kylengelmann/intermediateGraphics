...
//			RESULT:  global var 'partCount' sets # of particles;
//							I wrote & tested using partCount=3; found little slowdown until
//							number of particles exceeded 400,000 on my 4-year old
//							'high performance' laptop (nVIDIA M-2000 graphics processor).
//
// 	BouncyBall07:----------------
//		--delete old commented-out leftovers from BouncyBall06.
//		--create roundRand2D(),3D() to help initialize particle vectors without
//			'square' bias (plot of vector probabilities forms disc, not a square).
//			Use them to improve PartSys_init() function to stop square patterns. 
...
var partCount = 3000;				// # of particles in our state variable s[0] that
...
//============================================================================== 
  gl.clear(gl.COLOR_BUFFER_BIT);  				// Clear <canvas>
	// shall we update particle system state?
  if(myRunMode>1) {												// 0=reset; 1= pause; 2=step; 3=run
		...
		// -- apply acceleration due to gravity to current velocity:
			...
			if(s0[PART_XPOS+ pOff] >=  1.8) s0[PART_XPOS+ pOff] = 1.8;
			if(s0[PART_YPOS+ pOff] >=  1.8) s0[PART_YPOS+ pOff] = 1.8;
			//============================================
