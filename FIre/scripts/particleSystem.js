...
class Particle {
	...
	getTimeAlive() {
		return this.state.stateVector[this.offset + PARTICLE_TIME_ALIVE];
	}
	setTimeAlive(time) {
		this.state.stateVector[this.offset + PARTICLE_TIME_ALIVE] = time;
	}
}
...
class particleState {
	...
	getTimeAlive(num) {
		var offset = num*PARTICLE_ARRAY_SIZE;
		return this.state.stateVector[offset + PARTICLE_TIME_ALIVE];
	}
	setTimeAlive(num, time) {
		var offset = num*PARTICLE_ARRAY_SIZE;
		this.state.stateVector[offset + PARTICLE_TIME_ALIVE] = time;
	}
