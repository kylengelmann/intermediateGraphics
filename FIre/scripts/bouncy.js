...
var FSHADER_SOURCE =
  ...
  '  gl_FragColor = vec4(v_Color.r*col.r*col.a, v_Color.g*col.g*col.a, v_Color.b*col.b*col.a, v_Color.a*col.a);\n' +
  '}\n';
...
function main() {
  ...
  forces.push(constForce);


  initTexture("./luke.png", 0)
  ...
  for(var i = 0; i < numP; i++) {
    ...
    partSys.Particles[i*numP + j].setSize(60);
  ...
  var partUnifs = ["u_ModelMatrix", "u_ViewMatrix", "u_ProjMatrix", "u_tex"];
  ...
  partSys.renderer.setInt(gl, "u_tex", 0);
